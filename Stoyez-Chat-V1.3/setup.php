...
<body>
	<div class="banner">Stoyez Chat </div>
		...
		<div class="superUsr">
			<label for="superUsr">
				<b>SuperAdmin Username: </b>
			</label>
			<input type="text" placeholder="Enter Username" name="adminUser" id="size" required>
			<br>
			<label for="superUsrPass">
				<b>SuperAdmin Password: </b>
			</label>
			<input type="password" placeholder="Enter Password" name="adminPass" id="size" required>
		</div>
		...
		<div class="superButton">
			<button name="submit-setup" type="submit">Setup & Create Admin Account</button>
		</div>
	</div>
</body>
</html>
